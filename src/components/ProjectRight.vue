  ...
  <div class="flex">
    <div class="flex flex-col justify-center w-full mx-auto right-foreground lg:w-5/12 z-50">
      ...
      <div v-if="project.getType() == 'web'"
        class="w-full lg:w-7/12 cursor-pointer accent-filter-transparent lg:accent-filter hover:no-filter ease-in-out duration-100">
      ...
      <div
        ...
        class="flex flex-col w-full lg:flex-row lg:justify-between lg:w-7/12">
            ...
            class="w-1/2 mx-auto lg:mx-0 lg:w-3/12 rounded-md cursor-pointer accent-filter-transparent lg:visible lg:accent-filter hover:no-filter ease-in-out duration-100"/>
            <img
            :src="getImageSource(1)"
            class="hidden w-0 rounded-md cursor-pointer accent-filter-transparent lg:flex lg:w-3/12 lg:accent-filter hover:no-filter ease-in-out duration-100"/>
            <img
